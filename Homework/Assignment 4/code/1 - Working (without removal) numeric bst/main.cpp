...
bool manager(menuType & menu, treeClass & tree);   //Manages the main 
...
int main()
{
  ...
  while(manager(menu, tree));  //The main loop of the program
...
bool manager(menuType & menu, treeClass & tree)
{
  menu.disp();
  menu.choose();
  menu.process(tree);
