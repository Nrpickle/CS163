...
This is the main implementation file, and it handles the main() function, but the only function it preforms is to handle the main executing loop while handling the menu class
*/
